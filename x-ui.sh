...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/violetaini/chitanda/3x-ui/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/violetaini/chitanda/3x-ui/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://raw.githubusercontent.com/violetaini/chitanda/3x-ui/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
